...
public class TreasureIsland2 {
    /**
     * Amazon question: https://leetcode.com/discuss/interview-question/356150
     *
     * You have a map that marks the locations of treasure islands.
     * Some of the map area has jagged rocks and dangerous reefs.
     * Other areas are safe to sail in. There are other explorers trying to find the treasure. So you must figure out a shortest route to one of the treasure islands.
     *
